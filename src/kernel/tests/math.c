...
static const unsigned long long _multiplier = 0x5DEECE66DULL;
static const unsigned long long _addend = 0xB;
static const unsigned long long _mask = (1ULL << 48) - 1;
static unsigned long long _seed = 1;

// Assume that 1 <= _bits <= 32
static unsigned long randBits(int _bits)
{
        unsigned long rbits;
        unsigned long long nextseed = (mul64(_seed, _multiplier) + _addend) & _mask;
        _seed = nextseed;
        rbits = nextseed >> 16;
